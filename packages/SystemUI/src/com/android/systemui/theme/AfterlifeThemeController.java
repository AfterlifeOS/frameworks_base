...
public class AfterlifeThemeController {

    private static final String TAG = "AfterlifeThemeController";
    private final ContentResolver mContentResolver;
    private final Handler mBackgroundHandler;

    public AfterlifeThemeController(ContentResolver contentResolver, Handler backgroundHandler) {
